part of 'package:pos_final/pages/field_force.dart';
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Visibility(
                                                        visible:
                                                            fieldForceList[index]['contact']['contact_numbers']
                                                                .length >
                                                            0,
                                                        child: Text(
                                            ...
                                            Container(
                                              child: Visibility(
                                                ...
                                                child: IconButton(
                                                  ...
                                                  onPressed: () async {
                                                    String address =
                                                        (fieldForceList[index]['visited_address_latitude'] !=
                                                                null &&
                                                            fieldForceList[index]['visited_address_latitude'] !=
                                                                null)
                                      ...
                                      meetValue(
                                        ...
                                        fieldForceList[index]['meet_with_mobile_no'],
                                        fieldForceList[index]['meet_with_designation'],
                                      ),
                                      meetValue(
                                        2,
                                        fieldForceList[index]['meet_with2'],
                                        fieldForceList[index]['meet_with_mobile_no2'],
                                        fieldForceList[index]['meet_with_designation2'],
                                      ),
                                      meetValue(
                                        3,
                                        fieldForceList[index]['meet_with3'],
                                        fieldForceList[index]['meet_with_mobile_no3'],
                                        fieldForceList[index]['meet_with_designation3'],
                                      ),
                                    ],
                                  ),
                                ),
  ...
  Widget fieldVisitStatus() {
    return DropdownButtonHideUnderline(
      child: DropdownButton(
        ...
        items: fieldForceStatusList.map<DropdownMenuItem<String>>((
