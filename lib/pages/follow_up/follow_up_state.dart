part of 'package:pos_final/pages/follow_up.dart';
        ...
        Expanded(
          child: (followUpList.length > 0)
              ? ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: (followUpList.isNotEmpty)
                      ? followUpList.length
                      : 0,
    ...
    return Container(
      child: Column(
        ...
        children: [
          ...
          Visibility(
            visible:
                (followUpDetails['customer']['name'] != null &&
            ...
            children: [
              ...
              Column(
                ...
                children: [
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        await FollowUpApi()
                            ...
                            .then((value) {
                              var customerDetails = FollowUpModel()
                                  .followUpForm(value);
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) =>
                                      FollowUpForm(customerDetails, edit: true),
                                ),
                              );
                            });
                      },
                  ...
                  Visibility(
                    visible:
                        (followUpDetails['schedule_type'] == 'call' &&
                        followUpDetails['status'] == 'open'),
                    child: Helper().callDropdown(context, followUpDetails, [
  ...
  Widget followUpStatus() {
    return DropdownButtonHideUnderline(
      child: DropdownButton(
        ...
        items: followUpStatusList.map<DropdownMenuItem<String>>((String value) {
