part of 'package:pos_final/pages/shipment.dart';
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(MdiIcons.calendarClock, color: Colors.green.shade900),
                    Text(
                      ' $date',
                      style: AppTheme.getTextStyle(
                        themeData.textTheme.titleMedium,
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        shippingDialog(
                          ...
                          address: shipments[index]['shipping_address'] ?? '',
                        );
                      },
                      child: Container(
                ...
                Row(
                  children: [
                    Icon(MdiIcons.googleMaps, color: Colors.red),
                    Container(
    ...
    if (nextPage != null) {
      await dio.get(nextPage!).then((value) {
        ...
        shipment.forEach((element) async {
          Map<String, dynamic> customer = await getCustomerNameById(
            element['contact_id'],
          );
          setState(() {
            shipments.add({
